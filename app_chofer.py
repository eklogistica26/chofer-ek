...
def main(page: ft.Page):
    # --- BLOQUE DE SEGURIDAD ANTI-PANTALLA GRIS ---
    try:
        print("🚀 INICIANDO V22 (EMOJIS SEGUROS)...")
        ...
        # USO DE EMOJIS EN LUGAR DE ICONOS PARA EVITAR ERRORES
        vista_inicio = ft.Column(
            [
                ft.Text("🚛", size=50), # Emoji Camión
                    ...
                    for row in rows:
                        ...
                        tarjeta = ft.Container(
                            ...
                            content=ft.Column([
                                ...
                                ft.Row([
                                    ft.Text("📍", size=16), # Emoji Pin
                                    ft.Text(f"{dom}", size=12, color="#333333", expand=True),
                                    # BOTON DE MAPA ROBUSTO (Sin Icono problematico)
                                    ft.ElevatedButton(
                                        "🗺️ IR", 
        ...
        # BOTON FOTO CON EMOJI
        btn_foto = ft.ElevatedButton("📷 FOTO (Opcional)", bgcolor="grey", color="white")
        ...
        # SI ALGO FALLA, NO MUESTRA GRIS, MUESTRA EL ERROR EN ROJO
        page.add(ft.Text(f"⚠️ ERROR CRÍTICO: {e_main}", color="red", size=20))
