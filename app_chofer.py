        ...
        if conn:
            try:
                ...
                if res:
                    ...
                    col_resultado_busqueda.controls.append(ft.Container(content=ft.Column([ft.Text(f"Guía: {guia}", size=18, weight="bold"), ft.Text(f"Estado: {est}", color="blue"), btn_gestion]), bgcolor="white", padding=10, border_radius=10))
