...
class EditarPesoDHLDialog(QDialog):
    def __init__(self, op, parent=None):
        ...
        self.in_bultos.setValue(op.bultos or 1)
...
# 🔥 EL SUPER DIÁLOGO DE AJUSTE CON INTELIGENCIA DE VISITAS 🔥
...
class TabFacturacion(QWidget):
    def __init__(self, main_window):
        super().__init__()
        self.main = main_window; self.setup_ui()
    ...
    # 🔥 LA APERTURA DEL DIÁLOGO CON INTELIGENCIA DE RESTAR VISITAS DE OFICINA 🔥
    ...
    def calcular_cierre(self):
        ...
        try:
            ...
            # 🔥 INTELIGENCIA DE LISTADO PARA DESCONTAR VISITAS 🔥
    ...
    def generar_pdf_fact(self):
        ...
        data_filas = [['FECHA', 'GUÍA', 'ZONA', 'BULTOS / PESO', 'BASE ($)', 'EXTRAS ($)', 'TOTAL ($)']]
